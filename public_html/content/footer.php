    ...
    <div class="container">
        ...
        <section class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
                <p>Site elaborado por <b>QWERTY Code</b>/<b>Flor de Cacto Comunicação</b>. Desenvolvedores: <b><a href="https://www.about.me/EloisaSemH" target="_blank">Eloísa Carvalho</a></b> e
                    <b>Cesar August</b>.
                </p>
                <p class="h6">© Todos os direitos reservados.<a class="text-green" href="https://www.sunlimetech.com" target="_blank"> QWERTY Code
                        <?php echo date('Y'); ?></a>.</p>
