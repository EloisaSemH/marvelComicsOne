    ...
    <div class="container">
        ...
        <section class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-5">
                <ul class="list-unstyled list-inline social text-center">
                    ...
                    <li class="list-inline-item"><a href="mailto:flordecactocomunicacao@gmail.com" target="_blank"><i
        ...
        <section class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
                ...
                <p class="h6">© Todos os direitos reservados.<a class="text-green" href="https://www.sunlimetech.com"
                        target="_blank"> QWERTY Code
                        <?php echo date('Y'); ?></a>.</p>
