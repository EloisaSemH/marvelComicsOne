...
<nav class="col-lg-4 py-3">
    ...
    <ul class="list-group ">
        ...
        <li class="list-group-item list-group-item-action quick-links"><a href="characters.php">Personagens <span
                    class="badge badge-danger badge-pill text-right">
                    <? echo $numbers['characters']; ?>
        <li class="list-group-item list-group-item-action quick-links"><a href="series.php">Séries de
                quadrinhos <span class="badge badge-danger badge-pill text-right">
                    <? echo $numbers['series']; ?>
                </span></a></li>
    </ul>
</nav>