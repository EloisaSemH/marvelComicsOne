...
?>
<div id="index">
    <div id="grandeImg" class="mb-4 pb-4">

        <?php include_once('content/nav.php'); ?>

        <div class="text-center text-white mb-4 pb-4" id="apresentacao">
    ...
    <div class="bg-light pt-4">
        <div class="row mx-3 bg-light">
            <section class="col-12 col-sm-6 col-md-4 image-grid-item">
                <div style="background-image: url(images/4badc4e72154e-landscape_incredible.jpg);"
            ...
            <section class="col-12 col-sm-6 col-md-4 image-grid-item">
                <div style="background-image: url(images/4bb3bcffb8325-landscape_incredible.jpg);"
            ...
            <section class="col-12 col-sm-6 col-md-4 image-grid-item">
                <div style="background-image: url(images/57e94a282c8de-landscape_incredible.jpg);"
                    class="entry-cover image-grid-cover has-image">
            ...
            <section class="col-12 col-sm-6 col-md-4 image-grid-item">
                <div style="background-image: url(images/4bb579f597e57-landscape_incredible.jpg);"
                    class="entry-cover image-grid-cover has-image">
